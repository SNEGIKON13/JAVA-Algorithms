...
массив объектов Queue.
	 ...
	 4. Времени потрачено: 40 минут
+ **Задача 9**  
     1. Условие: Разработайте реализацию LSD-сортировки строк, которая способна работать со
строками переменной длины.
	 2. [Ссылка на задание :rewind:](https://github.com/SNEGIKON13/Java-Algorithms/tree/main/chapter_5.1/task_9)
	 3. Времени запланировано: 35 минут
	 4. Времени потрачено: 1 час
+ **Задача 13** 
     1. Условие: Гибридная сортировка. Обдумайте идею применения стандартной МSD-сортировки
строк для больших массивов, чтобы воспользоваться преимуществами мноrочастноrо разбиения,
и трехчастной быстрой сортировкой для меньших массивов, чтобы избежать nояменкя больших
количеств пустых карманов.
	 2. [Ссылка на задание :rewind:](https://github.com/SNEGIKON13/Java-Algorithms/tree/main/chapter_5.1/task__13) 
	 3. Времени запланировано: 1 час
	 4. Времени потрачено: 50 минут
+ **Задача 16** 
     1. Условие: Сортировка связного списка. Разработайте реализацию сортировки, которая
принимает в качестве арrумента связный список узлов с ключами типа String и
упорядочивает ero (возвращает ссылку на узел с наименьшим ключом). Воспользуйтесь
трехчастной быстрой сортировкой строк.
	 2. [Ссылка на задание :rewind:](https://github.com/SNEGIKON13/Java-Algorithms/tree/main/chapter_5.1/task_16)
	 3. Времени запланировано: 40 минут
	 4. Времени потрачено: 45 минут
...
+ **Задача 5**
     1. Условие: Напишите нерекурсивные версиии реализаций TrieST и TST.
	 2. [Ссылка на задание :rewind:](https://github.com/SNEGIKON13/Java-Algorithms/tree/main/chapter_5.2/task_5)
	 3. Времени запланировано: 1 час
	 4. Времени потрачено: 1 час
+ **Задача 13**  
     1. Условие: Гибридное ТТП с R²-частным ветвлением в корне. Добавьте в реализацию TST код
для выполнения многочастного ветвления на первых двух уровнях, как описано в тексте
	 2. [Ссылка на задание :rewind:](https://github.com/SNEGIKON13/Java-Algorithms/tree/main/chapter_5.2/task__13)
	 3. Времени запланировано: 40 минут
	 4. Времени потрачено: 35 минут
+ **Задача 14** 
     1. Условие: Уникальные подстроки длиной L. Напишите клиент TST, который вводит текст
 из стандартного ввода и подсчитывает в нем количество уникальных подстрок длиной L.
Например, входной текст cgcgggcgcg содержит пять уникальных подстрок длиной 3 - cgc, cgg, gcg,
ggc и ggg. Совет: выберите i-ю подстроку с помощью вызова substring (i, i + L) и вставьте
ее в таблицу имен.
...
в которых для представления образца и текста применяется массив char[], а не тип String.
	 ...
	 4. Времени потрачено: 45 минут
+ **Задача 26** 
     1. Условие:Проверка наличия цuклических перестановок. Напишите программу,
которая для заданных двух строк определяет, является ли одна из них циклической
перестановкой другой - например, пальто и топаль.
